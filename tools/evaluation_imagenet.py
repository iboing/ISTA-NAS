...
parser.add_argument('--save', type=str, default='./results/', help='experiment name')
...
parser.add_argument('--tmp_data_dir', type=str, default='/mnt/lustre/share/', help='temp data dir')
...
def main():
    ...
    if args.resume:
        if os.path.isfile(args.resume):
            ...
            top1_acc = checkpoint['best_acc_top1']
            print('best prec1:', top1_acc)
    ...
    data_dir = os.path.join(args.tmp_data_dir, 'images')
